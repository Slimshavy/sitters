...
class Recurringjobexception extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('reccuringjobid, startdate', 'required'),
			array('reccuringjobid, newstarttime, newendtime', 'numerical', 'integerOnly'=>true),
			array('enddate', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, reccuringjobid, startdate, enddate, newstarttime, newendtime', 'safe', 'on'=>'search'),
		);
	}
