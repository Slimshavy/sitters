...
class Job extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('scheduledstarttime, scheduledendtime', 'required'),
            ...
            array('babysitteruserid', 'default', 'value' => 0),
    ...
    public function beforeSave()
    {
        ...
        $this->lastupdateuserid = app()->user->id;

        if ($this->isNewRecord)
        {
            $this->parentuserid = app()->user - id;
